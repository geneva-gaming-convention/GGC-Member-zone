    ...
    var ha = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
        ...
        Ye.prototype.prepare = function() {
            ...
            insert: function(n, t) {
                ...
                this._ ? (n = or(this._), t.P = null, t.N = n, n.P = n.L = t, e = n) : (t.P = t.N = null, this._ = t, e = null);
        ...
        ao.layout.histogram = function() {
            ...
            function n(n, i) {
                ...
                s = f[0],
                h = t(s);
                if (oi(h, e), h.parent.m = -h.z, ui(h, r), c)
                ui(s, u);
                else {
                    var p = s,
                    g = s,
        ...
        ao.scale.quantile = function() {
            ...
            function n() {
                ...
                A.push("M", m, ",", M), null != x && A.push("A", c, ",", c, " 0 ", C, ",", p, " ", x, ",", b), A.push("L", _, ",", w), null != S && A.push("A", n, ",", n, " 0 ", L, ",", 1 - p, " ", S, ",", k);
